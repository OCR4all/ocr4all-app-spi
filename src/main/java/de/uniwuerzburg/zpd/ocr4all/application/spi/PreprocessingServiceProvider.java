/**
 * File:     PreprocessingServiceProvider.java
...
/**
 * Defines service provider interfaces for preprocessing.
 *
 * @author <a href="mailto:herbert.baier@uni-wuerzburg.de">Herbert Baier</a>
 * @version 1.0
 * @since 1.8
 */
public interface PreprocessingServiceProvider extends ProcessorServiceProvider<ProcessFramework> {
